# backend/app/services/banco_santander.py
# Client Open Finance Brasil para Santander.
...
class BancoSantanderClient:
    """Client Open Finance para Santander."""

    def __init__(self, account_id: str, cert_path: str | None = None):
        settings = get_settings()
        self.base_url = settings.SANTANDER_BASE_URL
        self.account_id = account_id
        self.cert_path = cert_path or settings.SANTANDER_CERT_PATH
    ...
    async def obter_saldo(self) -> dict:
        ...
        try:
            ...
            logger.error("santander_saldo_erro", account=self.account_id, erro=str(e))
            raise
    ...
    async def obter_transacoes(self, data_inicio: str, data_fim: str) -> dict:
        ...
        try:
            ...
            logger.error("santander_transacoes_erro", account=self.account_id, erro=str(e))
            raise
